    ...
    <div>
        <div id='slider' class='swipe'>
            <div class='swipe-wrap'>
                <div>
                    <table>
                        <tr v-for="r in currentMonth.length/7">
                            <td v-for="t in 7">
                                 {{ currentMonth[(r-1) * 7 + t-1].day   }}
                            </td>
                        </tr>
                    </table>
                </div>
                <div style="background: #f1f1f1">
                    <table>
                        <tr v-for="r in nextMonth.length/7">
                            <td v-for="t in 7">
                                {{ nextMonth[(r-1) * 7 + t-1].day   }}
                            </td>
                        </tr>
                    </table>
                </div>
                <div style="background: #f1f1f1">
                    <table>
                        <tr v-for="r in prevMonth.length/7">
                            <td v-for="t in 7">
                                {{ prevMonth[(r-1) * 7 + t-1].day   }}
                            </td>
                        </tr>
                    </table>
                </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            prevMonth() {
                return this.getDatesOfMonth(this.year,this.month-1)
            },
            currentMonth(){
                return this.getDatesOfMonth(this.year,this.month)
            },
            nextMonth(){
                return this.getDatesOfMonth(this.year,this.month+1)
            }
